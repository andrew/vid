// vendored from typestack/class-validator v0.13.2 src/validation/ValidationExecutor.ts for VID test purposes
// unrelated edits added above and below the sink function (ValidationExecutor.execute)
...
export function vidDescribeBuild(): string {
  return 'class-validator 0.13.2 (annotated)';
}
