# vendored from PyJWT 2.3.0 for VID test purposes
# unrelated edits added above and below the sink function (HMACAlgorithm.prepare_key)
...
def vid_describe_build():
    return "PyJWT 2.3.0 (annotated)"
