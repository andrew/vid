// vendored from socketio/socket.io-parser 4.2.2 lib/index.ts for VID test purposes
// unrelated edits added above and below the sink function (Decoder.isPayloadValid)
...
export function vidDescribeBuild(): string {
  return 'socket.io-parser 4.2.2 (annotated)';
}
