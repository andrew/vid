// vendored from apache/commons-text rel/commons-text-1.9 StringLookupFactory.java for VID test purposes
// unrelated edits added above and below the sink function (addDefaultStringLookups)
...
// unrelated helper appended after the original class body.
class VidDescribeBuild {
    static String describe() { return "commons-text 1.9 (annotated)"; }
}
