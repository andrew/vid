// vendored from opencontainers/runc v1.1.11 libcontainer/standard_init_linux.go for VID test purposes
// unrelated edits added above and below the sink function (linuxStandardInit.Init)
...
func vidDescribeStandardBuild() string {
	return "runc 1.1.11 standard_init_linux.go (annotated)"
}
