// vendored from stepancheg/rust-protobuf v3.4.0 protobuf/src/coded_input_stream/mod.rs for VID test purposes
// unrelated edits added above and below the sink function (CodedInputStream::skip_group)
...
// unrelated helper appended after the original module body.
fn vid_describe_build() -> &'static str {
    "rust-protobuf 3.4.0 (annotated)"
}
