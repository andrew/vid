// vendored from apache/logging-log4j2 rel/2.14.1 JndiManager.java for VID test purposes
// unrelated edits added above and below the sink function (JndiManager.lookup)
...
class VidDescribeBuild {
    static String describe() { return "log4j-core 2.14.1 (annotated)"; }
}
