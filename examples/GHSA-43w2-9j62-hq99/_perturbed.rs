// vendored from servo/rust-smallvec v1.6.0 src/lib.rs for VID test purposes
// unrelated edits added above and below the sink function (SmallVec::insert_many)
