/* vendored from gnome/libxml2 v2.9.10 entities.c for VID test purposes
 * unrelated edits added above and below the sink function (xmlEncodeEntitiesInternal)
...
static const char *vid_describe_build(void) {
  return "libxml2 2.9.10 (annotated)";
}
